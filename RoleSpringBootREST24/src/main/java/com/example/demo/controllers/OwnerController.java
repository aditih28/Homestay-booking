...
public class OwnerController {
	...
	public Owner saveOwner(@RequestBody OwnerRegistrationDummy ord)
	{
		...
		User u=new User(ord.getUsername(),ord.getPassword());
	...
	public BookingListDisplayDemo displayHotels(@RequestParam("ownerid") int ownerid) {
		BookingListDisplayDemo bookingList = oservice.getDisplayHotelList(ownerid);
		return null;	
	}*/
}
