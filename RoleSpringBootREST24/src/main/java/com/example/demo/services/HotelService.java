...
public class HotelService {
	...
	public Hotel saveHotel(HotelRegisterDummy hotel) {
	  ...
	  public HotelResponse createHotelResponse(HotelRegisterDummy request){
			...
			HotelResponse response = new HotelResponse(request.getHotelname(),request.getAddress(),stateId,cityId,request.getEmailid(),request.getPhone(),request.getDescription(),ownerId,request.getTotalrooms(),request.getPrice());
			return response;
