...
import 'bootstrap/dist/css/bootstrap.min.css';
    ...
    export default function OwnerAddHomestaysComp() {
      ...
      const homestaysData = {
        ...
        state: homestays.state.value,
        city: homestays.city.value,
...
<div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <input
              type="text"
              className={`form-control ${homestays.name.touched && !homestays.name.valid ? 'is-invalid' : ''}`}
              value={homestays.state.value}
              onChange={(e) => handleChange('state', e.target.value)}
              onBlur={(e) => handleChange('state', e.target.value)}
            />
            {homestays.state.touched && !homestays.state.valid && (
              <div className="invalid-feedback">{homestays.state.error}</div>
            )}
          </div>
          ...
          <div className="mb-3">
            ...
            <input
              type="text"
              className={`form-control ${homestays.name.touched && !homestays.name.valid ? 'is-invalid' : ''}`}
              value={homestays.city.value}
              onChange={(e) => handleChange('city', e.target.value)}
              onBlur={(e) => handleChange('city', e.target.value)}
            />
            {homestays.city.touched && !homestays.city.valid && (
              <div className="invalid-feedback">{homestays.city.error}</div>
            )}
          </div>
