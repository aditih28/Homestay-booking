          ...
          if (obj.approvestatus === false) {
            ...
            if (obj.status === "OK") {
              if (obj.role.roleid === 1) {
                ...
                obj.role.roleid === 2 &&
                obj.owner.propertytype === "homestay"
              ) {
                navigate("/homestayowner");
                ownerid = obj.owner.ownerid;
              } else if (
                obj.role.roleid === 2 &&
                obj.owner.propertytype === "hotel"
              ) {
                navigate("/hotelowner");
                ownerid = obj.owner.ownerid;
              } else if (obj.role.roleid === 3) {
    ...
    <div className="row">
      <div className="nav navbar">
        <div className="nav-item">
          New user?
          <Link to="/custreg" className="nav-link">
            Register new customer
          </Link>
        </div>
        <div className="nav-item">
          Extend your business!
          <Link to="/ownerregistration" className="nav-link">
            Register owner
          </Link>
        </div>
      </div>
      <div
        className="form-outline w-25 col-md-6 mx-auto h-100 d-flex align-items-center justify-content-center"
        width="w-50"
        align="center"
      >
        <form className="form-control-sm" align="center">
          ...
          <div className="mt-3">
          <p className="mb-0">
            Forgot Password?<Link to="/updatepassword">click here</Link>
