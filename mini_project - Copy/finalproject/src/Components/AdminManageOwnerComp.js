...
// // /*export default function AdminManageOwnerComp() {
...
// //  </div>
// // </div>
// // <div><h3>Admin control page to manage and authenticate owner information</h3></div>
// // </div> 
// //             )
// //      }*/
...
// //     fetch(`http://localhost:8080/${ownerid}/approve`)
// //       .then(response => {
// //         if (response.ok) {
// //           // Handle success
...
// //     fetch(`http://localhost:8080/${ownerid}/reject`)
// //     .then(response => {
// //       if (response.ok) {
// //         // Handle success
...
// //                  {/* <td>{Owner.UserID.approvestatus}</td>  */}
// //                 <td>
                  
// //                 {/* {console.log(typeof Owner.login_id.status_approve)} */}
// //                   {Owner.UserID.approvestatus ? 'Approved' : 'Rejected'}</td>
                
// //                 <td>
// //                   <button className="btn btn-success" onClick={() => handleApprove(Owner.UserID.UserID)}>Accept</button>
// //                   <button className="btn btn-danger ms-2" onClick={() => handleReject(Owner.UserID.UserID)}>Reject</button>
// //                 </td>
// //               </tr>
// //             ))}
// //           </tbody>
...
// //   );
// // };
// // export default AdminManageOwnerComp;
